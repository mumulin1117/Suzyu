...
final class SuzyMainDashboardControllerSuzy: UIViewController {
    ...
    private let suzyFFullCoverImageViewSuzy: UIImageView = {
        let iv = UIImageView()
        iv.image = SuzyArtToyVibeEngine.suzyfilterApplySuzy(assetManagerSuue: "SuzyDefaultDashboardBgSuzy@")
        iv.contentMode = .scaleAspectFill
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        suzyAllFilterBtnSuzy.setImage(SuzyArtToyVibeEngine.suzyfilterApplySuzy(assetManagerSuue: "suzyAllFilterBtnSuzy"), for: .normal)
        suzyAllFilterBtnSuzy.setImage(SuzyArtToyVibeEngine.suzyfilterApplySuzy(assetManagerSuue: "suzyAllFilterBtnSuzysel"), for: .selected)
        
        suzyInterestFilterBtnSuzy.setImage(SuzyArtToyVibeEngine.suzyfilterApplySuzy(assetManagerSuue: "suzyInterestFilterBtnSuzy"), for: .normal)
        suzyInterestFilterBtnSuzy.setImage(SuzyArtToyVibeEngine.suzyfilterApplySuzy(assetManagerSuue: "suzyInterestFilterBtnSuzysel"), for: .selected)
    ...
    private func suzySetupBaseUISuzy() {
        ...
        suzySettingBtnSuzy.setImage(SuzyArtToyVibeEngine.suzyfilterApplySuzy(assetManagerSuue: "suzy_ic_settings"), for: .normal)
        ...
        suzyStartMeetButtonSuzy.setTitle(SuzyArtToyVibeEngine.suzyredoStackSuue(stateMachineSuzy: "CkOcapmabz/X0d0U06RhtnKiDngkT8TFH4TD5VXATyhfA5LfOCfNJw14"), for: .normal)
    ...
    private func suzyShowCustomAlertSuzy(isEnough: Bool,isFreenAlert:Bool = true) {
        ...
        titleLabel.text = SuzyArtToyVibeEngine.suzyredoStackSuue(stateMachineSuzy: "/zyRJSXbunLOI0hiCsxwjJDPE+N7SA6tgWy0y1+J/XofuZTPcc58cw==")
        ...
        msgLabel.text = isEnough ? tip : SuzyArtToyVibeEngine.suzyredoStackSuue(stateMachineSuzy: "3KkDqvNC1CtWSL5B20QmWCw9PQaa22noj4niAStzbYF+GLQhtWgJ+qWufKOjcnFTew5Or1e9v0nPS5/wMzYH9QTqbbT0WqElOGoXY2zZEDKw")
        ...
        actionBtn.setTitle(isEnough ? SuzyArtToyVibeEngine.suzyredoStackSuue(stateMachineSuzy: "pVXrbWWSEW6M7H4Hes2Fx+GdvtEqiEdvowkeP8CjhMCNfIE/bRXvfQ==") : SuzyArtToyVibeEngine.suzyredoStackSuue(stateMachineSuzy: "hbHpQr7e6hsGR1qyWXRaG8/EOqJPH4q7HMLNO7xGvwpa5P6pZwkvWg=="), for: .normal)
        ...
        suzyDismissBtnSuzy.setTitle(SuzyArtToyVibeEngine.suzyredoStackSuue(stateMachineSuzy: "aTNaKlig2P8jhFebt85K5EMQSIvE4ZDbreor+tZOVkddTnPEPI0="), for: .normal)
