...
class SuzymagneticBubbleCell: UITableViewCell {
    ...
    func configure(msg: SuzyChatDetailRecord, genderImg: String?) {
        ...
        if msg.isMine {
            ...
            avatarImg.image = SuzyArtToyVibeEngine.suzyfilterApplySuzy(assetManagerSuue: genderImg ?? "")
